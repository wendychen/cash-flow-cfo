...
const ExpenseTracker = () => {
  ...
  // Zustand store (source of truth + automatic persistence + migration)
  const {
    expenses,
    incomes,
    savings,
  ...
  // UI-only local state (not persisted in the domain store)
  ...
  // Old goals/tasks reconstruction + persistence effects removed.
  // All data now lives in the Zustand store (normalized model + automatic persistence).
