        ...
        return (
          <div key={date} className="animate-fade-in">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-medium text-primary whitespace-nowrap tabular-nums">
                ...
                if (page === "...") {
                  return (
                    <PaginationItem key={`ellipsis-${idx}`}>
                      <span className="inline-flex h-9 w-9 items-center justify-center rounded-md text-sm text-muted-foreground">
                        ...
                      </span>
                    </PaginationItem>
                  );
