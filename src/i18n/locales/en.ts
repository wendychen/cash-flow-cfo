export const en = {
  ...
  printReport: {
    ...
    goals: {
      title: 'Cash Flow CFO — Goals Report',
      printedAt: 'Printed {date} · Display currency: {currency}',
      summary: '{active} active · {completed} completed · {tasks} tasks',
      activeGoals: 'Active Goals ({count})',
    ...
    goalReach: {
      title: 'Goal Reach Plan',
      feasibility: 'Feasibility',
      atRisk: 'Goals at risk',
      savingsGap: 'Savings gap',
      conflicts: 'Conflicts',
      noConflicts: 'No conflicts',
      weeklyFocus: 'Weekly focus',
      noWeeklyFocus: 'Nothing due this week',
      monthlyFunding: 'Monthly funding (12 mo)',
      month: 'Month',
      goal: 'Goal',
      amount: 'Amount',
      noFunding: 'No funding scheduled',
      conflictTypes: {
    ...
    income: {
      ...
      directCash: 'Direct cash',
      collections: 'Collections',
      outstandingAccrued: 'Outstanding accrued',
      total: 'Total (cash + outstanding)',
      category: 'Category',
      amount: 'Amount',
      ...
      outstanding: 'Outstanding',
      status: 'Status',
      fromAccrued: 'From accrued',
      note: 'Note',
      fullyCollected: 'Fully collected',
      percentCollected: '{percent}% collected',
      noAccrued: 'No accrued income records.',
      noCollections: 'No collection entries recorded.',
    },
    backup: {
      title: 'Cash Flow CFO — Backup Report',
      printedAt: 'Printed {date}',
      snapshotInfoOne: 'Auto-backup keeps the last snapshot locally in your browser.',
      snapshotInfoPlural: 'Auto-backup keeps the last {count} snapshots locally in your browser.',
      currentData: 'Current Data (Live)',
      domain: 'Domain',
      records: 'Records',
      ...
      latest: 'Latest',
      slotNumber: '#{n}',
      noBackups: 'No auto-backups stored yet.',
      notesTitle: 'Notes',
      noteExportJson: 'Use Export JSON in the app for a full portable backup file.',
      noteLocalStorage: "Auto-backups are stored only in this browser's local storage.",
      noteRestore: 'Restore from the latest auto-backup via the Dashboard when needed.',
    },
    domains: {
      expenses: 'Expenses',
      incomes: 'Income',
      ...
      fixedExpenses: 'Fixed expenses',
      targets: 'Targets',
      longTermFinGoal: '20-year fin goal',
      goals: 'Goals',
      tasks: 'Tasks',
    },
  },
  goalReach: {
    ...
    breakdownHint: 'Score breakdown: budget, deadlines, surplus, milestones',
    breakdown: {
      budget: 'Budget {score}%',
      deadlines: 'Deadlines {score}%',
      surplus: 'Surplus {score}%',
      milestones: 'Milestones {score}%',
    },
    refresh: 'Refresh',
    export: {
      print: 'Print plan',
      csv: 'Export plan',
      printedAt: 'Printed {date} · Display currency: {currency}',
      summary: '{count} active goals · Feasibility {feasibility}%',
      success: 'Exported {filename} ({method})',
      empty: 'No active goals to export',
    },
    empty: 'No active goals to plan',
    ...
    timeline: {
      empty: 'Add deadlines to goals to see the timeline',
      funded: '{funded} / {need} funded',
      gap: 'Gap {amount}',
    },
    legend: {
      funded: 'Funded window',
      gap: 'Time gap',
      deadline: 'Deadline',
    },
    monthlyFunding: {
      title: 'Monthly funding',
      empty: 'No funding schedule to show',
      unallocated: 'Unallocated surplus',
    ...
    aiCoach: {
      ...
      promptLabel: 'Prompt',
      promptPlaceholder:
        'I have {count} goals. Suggest a 12-month sequence that hits deadlines with my current savings and monthly surplus.',
      includeConstraints: 'Include constraints',
      includeCashFlow: 'Include cash flow',
      generatePlan: 'Generate plan',
      applySelected: 'Apply selected',
      dismiss: 'Dismiss',
      copy: 'Copy',
      copied: 'Copied to clipboard',
      unavailable: 'AI Coach is not configured (missing server API key).',
